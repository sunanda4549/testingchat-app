...
export default function Dashboard() {
  ...
  const [ratingTotal, setRating] = useState(0)
  const [totalUsers, setTotalUsers] = useState(0)
  const fetchProducts = () => {
    setLoading(true);
    api("http://localhost:4000/products", "GET")
      .then(response => {
        let totalPrice = response.reduce((prev, current) => {
          return prev + current.productPrice;
        }, 0)
        let totalStock = response.reduce((prev, current) => {
          return prev + current.stock;
        }, 0)
        let totalRating = response.reduce((prev, current) => {
          return prev + current.rating;
        }, 0);
        let totalRatingOutOf = response.reduce((prev, current) => {
          return prev + current.ratingTotal;
        }, 0);
        let averageRating = totalRating / totalRatingOutOf;
        ...
        <div className="col-xl-3 col-sm-6 grid-margin stretch-card">
          <div className="card">
            <div className="card-body">
              <div className="row">
                <div className="col-9">
                  <div className="d-flex align-items-center align-self-start">
                    <h3 className="mb-0">${totalProductPrice.toFixed(2)}</h3>
              ...
              <h6 className="text-muted font-weight-normal">Products Price</h6>
            </div>
          </div>
        </div>
        <div className="col-xl-3 col-sm-6 grid-margin stretch-card">
          <div className="card">
            <div className="card-body">
              <div className="row">
                <div className="col-9">
                  <div className="d-flex align-items-center align-self-start">
                    <h3 className="mb-0">{totalStock.toFixed(2)}</h3>
              ...
              <h6 className="text-muted font-weight-normal">Total Stock</h6>
            </div>
          </div>
        </div>
        <div className="col-xl-3 col-sm-6 grid-margin stretch-card">
          <div className="card">
            <div className="card-body">
              <div className="row">
                <div className="col-9">
                  <div className="d-flex align-items-center align-self-start">
                    <h3 className="mb-0">{ratingTotal.toFixed(2)}</h3>
                  </div>
                </div>
                <div className="col-3">
              ...
              <h6 className="text-muted font-weight-normal">Overall Rating</h6>
            </div>
          </div>
        </div>
        <div className="col-xl-3 col-sm-6 grid-margin stretch-card">
