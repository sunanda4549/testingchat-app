      ...
      <nav className="sidebar sidebar-offcanvas" id="sidebar">
        ...
        <ul className="nav">
          ...
          <li className={this.isPathActive('/basic-ui') ? 'nav-item menu-items active' : 'nav-item menu-items'}>
            <div className={this.state.basicUiMenuOpen2 ? 'nav-link menu-expanded' : 'nav-link'} onClick={() => this.toggleMenuState('basicUiMenuOpen2')} data-toggle="collapse">
              <span className="menu-icon">
                <i className="mdi mdi-wechat"></i>
              </span>
              <span className="menu-title"><Trans>Chatting</Trans></span>
              <i className="menu-arrow"></i>
            </div>
            <Collapse in={this.state.basicUiMenuOpen2}>
              <div>
                <ul className="nav flex-column sub-menu">
                  <li className="nav-item"> <Link className={this.isPathActive('/basic-ui/chats') ? 'nav-link active' : 'nav-link'} to="/basic-ui/chats"><Trans>Chats</Trans></Link></li>
                </ul>
              </div>
            </Collapse>
          </li>
            ...
            <Collapse in={this.state.formElementsMenuOpen}>
              <div>
                <ul className="nav flex-column sub-menu">
                  ...
                  <li className="nav-item"> <Link className={this.isPathActive('/form-elements/users') ? 'nav-link active' : 'nav-link'} to="/form-elements/users"><Trans>User Form</Trans></Link></li>
                </ul>
              </div>
            </Collapse>
          </li>
            ...
            <Collapse in={this.state.tablesMenuOpen}>
              <div>
                <ul className="nav flex-column sub-menu">
                  ...
                  <li className="nav-item"> <Link className={this.isPathActive('/tables/users') ? 'nav-link active' : 'nav-link'} to="/tables/users"><Trans>Users</Trans></Link></li>
                  <li className="nav-item"> <Link className={this.isPathActive('/tables/products') ? 'nav-link active' : 'nav-link'} to="/tables/products"><Trans>Products</Trans></Link></li>
                  <li className="nav-item"> <Link className={this.isPathActive('/tables/orders') ? 'nav-link active' : 'nav-link'} to="/tables/orders"><Trans>Orders</Trans></Link></li>
                </ul>
              </div>
            </Collapse>
          </li>
            ...
            <Collapse in={this.state.chartsMenuOpen}>
              <div>
                <ul className="nav flex-column sub-menu">
                  ...
                  <li className="nav-item"> <Link className={this.isPathActive('/charts/products') ? 'nav-link active' : 'nav-link'} to="/charts/products"><Trans>Products Chart</Trans></Link></li>
                </ul>
              </div>
            </Collapse>
          </li>
